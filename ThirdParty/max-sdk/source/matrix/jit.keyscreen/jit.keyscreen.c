                                  ...
                                  t_jit_matrix_info* in3_minfo, char* bip3, t_jit_matrix_info* out_minfo, char* bop)
{
    ...
    switch (dimcount) {
        ...
        case 2:
            ...
            ksrc = (key == 1) ? bip3 : (key == 2) ? bip2
                                                  : bip;
            tsrc = (target == 0) ? bip : (target == 2) ? bip2
                                                       : bip3;
            msrc = (mask == 0) ? bip : (mask == 1) ? bip3
                                                   : bip2;

            kstride = (key == 1) ? in3_minfo->dimstride[1] : (key == 2) ? in2_minfo->dimstride[1]
                                                                        : in_minfo->dimstride[1];
            tstride = (target == 0) ? in_minfo->dimstride[1] : (target == 2) ? in2_minfo->dimstride[1]
                                                                             : in3_minfo->dimstride[1];
            mstride = (mask == 1) ? in_minfo->dimstride[1] : (mask == 1) ? in3_minfo->dimstride[1]
                                                                         : in2_minfo->dimstride[1];
                ...
                default:
                    for (i = 0; i < height; i++) {
                        ...
                        for (j = 0; j < width; j++, ip += 4, ip2 += 4, ip3 += 4) {
                            ...
                            *op32++ = (*ip < aMf) ? *((t_uint32*)ip2) : (*ip > aPf)     ? *((t_uint32*)ip2)
                                                                    : (*(ip + 1) < rMf) ? *((t_uint32*)ip2)
                                                                    : (*(ip + 1) > rPf) ? *((t_uint32*)ip2)
                                                                    : (*(ip + 2) < gMf) ? *((t_uint32*)ip2)
                                                                    : (*(ip + 2) > gPf) ? *((t_uint32*)ip2)
                                                                    : (*(ip + 3) < bMf) ? *((t_uint32*)ip2)
                                                                    : (*(ip + 3) > bPf) ? *((t_uint32*)ip2)
                                                                                        : *((t_uint32*)ip3);
                        }
                    }
                    break;
