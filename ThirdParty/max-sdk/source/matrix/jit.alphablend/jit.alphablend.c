...
t_jit_err jit_alphablend_matrix_calc(t_jit_alphablend* x, void* inputs, void* outputs)
{
    ...
    if (x && in1_matrix && in2_matrix && out_matrix) {
        ...
        // compatible types?
        if (((in1_minfo.type != _jit_sym_char) && (in1_minfo.type != _jit_sym_float32) && (in1_minfo.type != _jit_sym_float64)) || (in1_minfo.type != in2_minfo.type) || (in1_minfo.type != out_minfo.type)) {
