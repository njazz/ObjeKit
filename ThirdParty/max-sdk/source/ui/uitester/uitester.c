...
void snippet_curve_to(t_jgraphics* cr, double width, double height)
{
    ...
    jgraphics_set_line_width(cr, 0.03);
    jgraphics_move_to(cr, x, y);
    jgraphics_line_to(cr, x1, y1);
    jgraphics_move_to(cr, x2, y2);
    jgraphics_line_to(cr, x3, y3);
    jgraphics_stroke(cr);
}
...
void snippet_set_line_cap(t_jgraphics* cr, double width, double height)
{
    ...
    jgraphics_move_to(cr, 0.25, 0.2);
    jgraphics_line_to(cr, 0.25, 0.8);
    jgraphics_stroke(cr);
    jgraphics_set_line_cap(cr, JGRAPHICS_LINE_CAP_ROUND);
    jgraphics_move_to(cr, 0.5, 0.2);
    jgraphics_line_to(cr, 0.5, 0.8);
    jgraphics_stroke(cr);
    jgraphics_set_line_cap(cr, JGRAPHICS_LINE_CAP_SQUARE);
    jgraphics_move_to(cr, 0.75, 0.2);
    jgraphics_line_to(cr, 0.75, 0.8);
    jgraphics_stroke(cr);
